...
cmd_help() {
  ...
  echo -e "    ${GREEN}deploy packages${NC}  Deploy carve-out (nodes/rx/prompts): rsync + build + restart"
  echo -e "    ${GREEN}deploy design${NC}    Deploy rx/ design only: rsync + restart (no build)"
